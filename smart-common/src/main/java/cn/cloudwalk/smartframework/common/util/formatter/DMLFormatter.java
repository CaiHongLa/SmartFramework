...
public class DMLFormatter implements SqlFormatter {
    ...
    public String format(String source) {
        return (new DMLFormatter.FormatProcess(source)).perform();
    }
    ...
    private static class FormatProcess {
        ...
        private static boolean isFunctionName(String tok) {
            ...
            return isIdentifier && !DMLFormatter.LOGICAL.contains(tok) && !DMLFormatter.END_CLAUSES.contains(tok) && !DMLFormatter.QUANTIFIERS.contains(tok) && !DMLFormatter.DML.contains(tok) && !DMLFormatter.MISC.contains(tok);
        }
        ...
        public String perform() {
            ...
            while (this.tokens.hasMoreTokens()) {
                ...
                if (this.afterByOrSetOrFromOrSelect && ",".equals(this.token)) {
                    ...
                    this.closeParen();
                } else if (DMLFormatter.BEGIN_CLAUSES.contains(this.lcToken)) {
                    this.beginNewClause();
                } else if (DMLFormatter.END_CLAUSES.contains(this.lcToken)) {
                    this.endNewClause();
                } else if ("select".equals(this.lcToken)) {
                    this.select();
                } else if (DMLFormatter.DML.contains(this.lcToken)) {
                ...
                } else if (DMLFormatter.LOGICAL.contains(this.lcToken)) {
                    this.logical();
